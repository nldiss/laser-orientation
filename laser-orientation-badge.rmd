...
-   603 rows (number of students) and 30 columns (variables)

-   Different students have different courses
...
-   It changed the number of rows - there were 438 students with more
    than 70 score, but when I changed the threshold to 80, there's only
    355 students.
...
ggplot(d, aes(x = percentage_earned)) +
  geom_histogram(fill = "chartreuse1")
```
